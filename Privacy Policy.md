...
The Bot only collects the minimum data required for functionality, such as:
...
- Message excerpts, instructions, or images explicitly submitted to the Bot may be transmitted to the AI provider to generate responses.
- No training, fine-tuning, or long-term user profiling is performed by the Bot.
...
For questions or requests related to this Privacy Policy or Terms of Service, contact:
- loxittoh@gmail.com
